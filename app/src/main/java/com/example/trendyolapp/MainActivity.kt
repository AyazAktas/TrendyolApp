...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            when (destination.id) {
               R.id.simdiAlFragment2, R.id.siparislerimFragment, R.id.siparisOnaylandiFragment, R.id.sepetimFragment, R.id.odemeSayfasiFragment -> binding.bottomNavigationBar.visibility = View.GONE
